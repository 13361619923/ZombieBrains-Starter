...
namespace ComponentsAndTags
{
    public readonly partial struct GraveyardAspect : IAspect
    {
        ...
        public int NumberTombstonesToSpawn => _graveyardProperties.ValueRO.NumberTombstoneToSpawn;
        ...
        {
            return ZombieSpawnPoints[_graveyardRandom.ValueRO.Value.NextInt(ZombieSpawnPoints.Length)];
        }
    }
}